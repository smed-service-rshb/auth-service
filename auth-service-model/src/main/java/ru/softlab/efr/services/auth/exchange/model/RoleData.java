...
public class RoleData  implements Serializable {
  private static final long serialVersionUID = 1L;
     ...
     */
    public RoleData(Long id, String name, String desc, List<String> rights) {
        this.id = id;
        this.name = name;
        this.desc = desc;
        this.rights = rights;
    ...
    **/
    ...
    public RoleData addRightsItem(String rightsItem) {
        if (this.rights == null) {
  ...
  @Override
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, roleData.id) &&
            ...
            Objects.equals(this.desc, roleData.desc) &&
            Objects.equals(this.rights, roleData.rights);
    }
