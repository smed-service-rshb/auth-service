...
public class RightsClient {
     ...
     */
    public RightsClient(MicroServiceTemplate microServiceTemplate) {
    ...
    */
    public GetAllRightsRs getAllRights(long timeout) throws RestClientException {
        return getAllRights().get(timeout);
    }

    /**
     * Запрос списка прав асинхронно
     * GET /auth/v1/rights
     *
     * @return 
     * @throws RestClientException в случае неудачи
    */
    public ClientRestResult<GetAllRightsRs> getAllRights() throws RestClientException {
        return new ClientRestResult<>(getAllRightsInternal(), this::processStatusCodeErrors);
    }

    private ListenableFuture<ResponseEntity<GetAllRightsRs>> getAllRightsInternal() throws RestClientException {
        

        MicroServiceURIBuilder uriBuilder = JmsUriBuilder.service(applicationName)
            .path(cutComments("/auth/v1/rights"));

        RequestEntity requestEntity = RequestEntity
                  .method(HttpMethod.GET, uriBuilder.build())
                  .build();
        return microServiceTemplate.exchange(requestEntity,
                    new ParameterizedTypeReference<GetAllRightsRs>(){});
    }
